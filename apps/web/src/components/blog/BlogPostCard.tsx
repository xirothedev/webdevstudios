...
export function BlogPostCard({ post }: BlogPostCardProps) {
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group border-wds-accent/30 bg-wds-background hover:border-wds-accent/50 block overflow-hidden rounded-lg border transition-all hover:shadow-lg"
    >
      {post.coverImage && (
      ...
      <div className="p-6">
        ...
        <div className="text-wds-text/50 flex items-center justify-between text-xs">
